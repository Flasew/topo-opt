...
//Read the data
d3.csv("heatmap16-4-dlrm.csv", function(data) {
  ...
  .call(d3.axisBottom(x).tickSize(0).tickValues(x.domain().filter(function(d, i) { return (i % 4 === 0 || i % 15 === 0); })))
  ...
  svg.append("g")
  .style("font-size", 15)
  .call(d3.axisLeft(y).tickSize(0).tickValues(y.domain().filter(function(d, i) { return (i % 4 === 0 || i % 15 === 0); })))
  .select(".domain").remove();
